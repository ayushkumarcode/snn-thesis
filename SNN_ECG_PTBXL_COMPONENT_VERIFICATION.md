...
- [snnTorch TBPTT API](https://snntorch.readthedocs.io/en/latest/snntorch.backprop.html)
- [snnTorch Tutorial 6 - Convolutional SNN](https://snntorch.readthedocs.io/en/latest/tutorials/tutorial_6.html)
- [snnTorch Leaky Source Code](https://snntorch.readthedocs.io/en/latest/_modules/snntorch/_neurons/leaky.html)
- [snnTorch GPU Memory Discussion](https://github.com/jeshraghian/snntorch/discussions/63)
- [PTB-XL Benchmarking GitHub](https://github.com/helme/ecg_ptbxl_benchmarking)
- [Deep Learning for ECG Analysis Paper](https://arxiv.org/abs/2004.13701)
- [SNN-ECG Review Paper (PMC)](https://pmc.ncbi.nlm.nih.gov/articles/PMC11362428/)
- [ECG Pre-Processing Best Practices](https://arxiv.org/pdf/2311.04229)
- [SciPy Butterworth Filter](https://docs.scipy.org/doc/scipy/reference/generated/scipy.signal.butter.html)
- [NeuroKit2 on PyPI](https://pypi.org/project/neurokit2/)
...
- [PyTorch Forum: Conv1d + snnTorch](https://discuss.pytorch.org/t/1d-data-surrogate-gradient-descent-in-a-convolutional-spiking-neural-network/157693)
- [Efficient Spiking Networks (ECG)](https://github.com/byin-cwi/Efficient-spiking-networks)
