# YC-Connected Hackathons in San Francisco -- February 28, 2026 Onwards

## Research Report
**Date of Research:** February 24, 2026
**Researcher:** Deep Research Investigator (Claude Opus 4.6)
**Scope:** All hackathons in San Francisco from February 28, 2026 onwards with any Y Combinator connection

---

## EXECUTIVE SUMMARY

After an exhaustive multi-vector investigation across events.ycombinator.com, Luma, Devpost, GarysGuide, Cerebral Valley, LinkedIn, X/Twitter, Instagram references, and dozens of other sources, I identified **2 confirmed upcoming hackathons** from February 28, 2026 onwards with verified YC connections. I also catalogued several past events (before Feb 28) and events whose future editions have not yet been announced.

The YC hackathon ecosystem is extremely active but event-driven -- most hackathons at YC HQ are announced only 2-6 weeks before they occur. The pattern shows that YC hosts roughly 2-3 hackathons per month at their SF office (560 20th St, San Francisco, CA 94107), typically organized by current-batch YC companies. Given this cadence, more hackathons will certainly be announced in March-June 2026, but they have not been publicly listed yet as of February 24, 2026.

---

## CONFIRMED UPCOMING HACKATHONS (February 28, 2026 Onwards)

### 1. Browser Use Web Agents Hackathon @ Y Combinator

| Field | Details |
|-------|---------|
| **Name** | Web Agents Hackathon |
| **Dates** | February 28 - March 1, 2026 (Saturday 12:00 PM - Sunday 2:30 PM) |
| **Location** | Y Combinator HQ, 560 20th St, San Francisco, CA 94107 |
| **Organizer** | Browser Use (YC W25) |
| **YC Connection** | Hosted AT YC HQ; organized by YC W25 company; offers guaranteed YC interview as prize |
| **Format** | ~26-hour overnight hackathon, in-person only |
| **Prizes** | Guaranteed YC Interview, week stay in Browser Use hacker house in SF, iPhone 17 Pros, AirPod Maxes, AirPod Pros, Sony XM5s, Keychron keyboards, tens of thousands of dollars in API credits |
| **Sponsors** | Google DeepMind, Convex, VibeFlow, AgentMail, Cubic, Hud, Superset, Laminar, Vercel, Supermemory, MongoDB, Dedalus Labs, Daytona, AWS |
| **Schedule** | Day 1: Lunch 12pm, Hacking 1pm, hack through night. Day 2: Hacking stops 10am, semi-finals 10am, lunch 12pm, finals & prizes 1pm, end 2:30pm |
| **Registration** | OPEN -- https://events.ycombinator.com/browser-use-hackathon |
| **Source** | https://browser-use.com/hackathon, https://events.ycombinator.com/browser-use-hackathon, https://x.com/gregpr07/status/2021355079652212825 |

**THIS IS THE MOST IMMINENT EVENT -- 4 DAYS FROM NOW.**

---

### 2. Agentic Payments Hackathon by Locus @ YC HQ (DATE UNCERTAIN -- Likely Future)

| Field | Details |
|-------|---------|
| **Name** | Agentic Payments Hackathon |
| **Dates** | TBD -- The events.ycombinator.com page is live but the exact date could not be extracted (JavaScript-rendered page). The page remains actively listed. Note: There was a November 15, 2025 edition, but the event page remains live, suggesting a possible future edition or the same page is being maintained. |
| **Location** | Y Combinator HQ, San Francisco |
| **Organizer** | Locus (YC F25) |
| **YC Connection** | Hosted AT YC HQ; organized by YC F25 company; offers guaranteed YC interview as grand prize |
| **Prizes** | $25,000 across multiple tracks; guaranteed YC interview for overall winner |
| **Sponsors/Partners** | Coinbase, OpenAI, Anthropic, Replit, Privy |
| **Focus** | Building new ways for AI agents to transact and pay autonomously |
| **Registration** | https://events.ycombinator.com/agenticpaymentshackathon |
| **Source** | https://events.ycombinator.com/agenticpaymentshackathon, https://x.com/aaron_epstein/status/1985796186780156303, https://x.com/CoinbaseDev/status/1985792129692811533 |

**STATUS: UNCERTAIN -- The November 2025 edition has occurred; it is unclear whether this specific page represents a future edition. Monitor this link.**
