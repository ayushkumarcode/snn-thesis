# ICONS 2026 -- Acceptance Process & Competitiveness

## Key Facts

| Question | Answer |
|----------|--------|
| Peer-reviewed? | Yes, fully. Likely single-blind, 2-3 reviewers |
| Acceptance rate | **~59%** (2023: 13/22 papers accepted for proceedings) |
| Rebuttal? | Yes (new for 2026). Reviews May 18 -> rebuttal May 25 -> decision June 5 |
| If rejected? | **Still presented as poster.** CFP says this explicitly. |
| Best paper awards? | Yes. 2023: NIST. 2024: TU Dresden + NIST. 2025: Sandia. |
| Student-friendly? | Very. Doctoral consortium, student poster competition (21 in 2023) |
| APC | Likely $0 for UoM (JISC/ACM Open agreement covers 70+ UK institutions) |
| Quality bar | National labs + major unis + PhD students. Not elite-only. |
| Compared to others | More focused than IJCNN, less competitive than NeurIPS, ideal for neuromorphic hardware papers |

## Timeline

| Date | Event |
|------|-------|
| April 1 | Submit PDF via EasyChair |
| May 13 | Reviews complete |
| May 18 | Reviews sent to authors |
| May 25 | Author rebuttals due (7 days) |
| June 5 | Accept/reject decision |
