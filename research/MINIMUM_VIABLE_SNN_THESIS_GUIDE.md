...
Reference Horowitz (2014) for MAC/AC energy values at 45nm technology node:
- 32-bit float MAC: ~4.6 pJ
- 32-bit float ADD: ~0.9 pJ

This analysis, even as an estimate, really strengthens the thesis by connecting experimental results to the real-world motivation for SNN research.
