...
- [SNN-Based RL for 3D Robotic Arm, MDPI 2025](https://www.mdpi.com/2079-9292/14/3/578)
- [SNNs for Continuous Control, arxiv 2025](https://arxiv.org/html/2509.05356v2)
- [Directly-trained SNNs for RL Obstacle Avoidance, ScienceDirect 2023](https://www.sciencedirect.com/science/article/pii/S0925231223010081)
- [SNN for UAV Obstacle Avoidance, IEEE 2019](https://ieeexplore.ieee.org/document/8867860/)
- [SNN SLAM on Loihi, IEEE 2019](https://ieeexplore.ieee.org/document/8967864/)
- [Semantic Spiking Neural SLAM, GitHub](https://github.com/nsdumont/Semantic-Spiking-Neural-SLAM-2023)
- [SNNs as Controllers for Swarm Agents, arxiv 2024](https://arxiv.org/abs/2410.16175)
- [SNN for Myoelectric Control, Frontiers 2023](https://www.frontiersin.org/journals/neuroscience/articles/10.3389/fnins.2023.1174760/full)
- [Optical Flow from Event Cameras and SNNs, Frontiers 2023](https://www.frontiersin.org/journals/neuroscience/articles/10.3389/fnins.2023.1160034/full)
- [OF_EV_SNN GitHub](https://github.com/j-cuadrado/of_ev_snn)

### Part 3: Unconventional
- [DSQN for Atari, arxiv 2022](https://arxiv.org/abs/2201.09754)
- [Convolutional SNN for Intrusion Detection, Nature 2024](https://www.nature.com/articles/s41598-024-57691-x)
- [TASNN for IDS, Nature 2026](https://www.nature.com/articles/s41598-026-37367-4)
- [SNN for Autonomous Driving, NeurIPS 2024](https://arxiv.org/abs/2405.19687)
- [SAD GitHub](https://github.com/ridgerchu/SAD)
- [Time-Series Forecasting with SNNs, arxiv 2024](https://arxiv.org/abs/2402.01533)
- [Financial Time Series with SNNs, Nature 2023](https://www.nature.com/articles/s41598-023-42605-0)
- [SPIDEN Image Denoising, Frontiers 2023](https://www.frontiersin.org/journals/neuroscience/articles/10.3389/fnins.2023.1224457/full)
- [SNNSIR Stereo Image Restoration, arxiv 2025](https://arxiv.org/pdf/2508.12271)
- [Privacy in Federated Learning with SNNs, arxiv 2025](https://arxiv.org/abs/2511.21181)
- [Federated SNN Differential Privacy, arxiv 2026](https://arxiv.org/abs/2602.12009v1)
- [SNN for Sequential Recommendation, IJCAI 2025](https://www.ijcai.org/proceedings/2025/0398.pdf)
- [SNN for ECG Classification Review, PMC 2024](https://pmc.ncbi.nlm.nih.gov/articles/PMC11362428/)
- [SpikeGPT, arxiv 2023](https://arxiv.org/html/2302.13939v5)
- [SNN for EEG BCI, IEEE 2023](https://ieeexplore.ieee.org/document/10049464/)
- [P450 Bioactivity Screening with SNN, Springer 2025](https://link.springer.com/chapter/10.1007/978-3-031-90714-2_20)
