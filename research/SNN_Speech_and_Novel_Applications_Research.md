...
- [SpikeVoice: High-Quality TTS Via Efficient SNN (ACL 2024)](https://aclanthology.org/2024.acl-long.429/)
- [Spiking Vocos: An Energy-Efficient Neural Vocoder (arXiv, 2025)](https://arxiv.org/abs/2509.13049)
- [Spiking-FullSubNet for Speech Enhancement (arXiv, 2024)](https://arxiv.org/abs/2410.04785)
- [DPSNN: Streaming Speech Enhancement (arXiv, 2024)](https://arxiv.org/abs/2408.07388)
- [Three-Stage Hybrid SNN for Speech Enhancement (Frontiers, 2025)](https://www.frontiersin.org/journals/neuroscience/articles/10.3389/fnins.2025.1567347/full)
- [IML-Spikeformer for Speech Processing (IEEE TNNLS, 2025)](https://arxiv.org/abs/2507.07396)
- [SpikeSCR: Knowledge Distillation for Speech Commands (arXiv, 2024)](https://arxiv.org/html/2412.12858v1)
- [Spiking Music: Audio Compression (arXiv, 2024)](https://arxiv.org/abs/2402.01571)
- [SNN and Sound: Comprehensive Review (Biomedical Engineering Letters, 2024)](https://link.springer.com/article/10.1007/s13534-024-00406-y)
- [SpikeYOLO: ECCV 2024 Best Paper Candidate](https://github.com/BICLab/SpikeYOLO)
- [Spiking-GAN (arXiv, 2021)](https://arxiv.org/abs/2106.15420)
- [Spiking-Diffusion: VQ Discrete Diffusion (arXiv, 2023)](https://arxiv.org/abs/2308.10187)
- [Spiking DDPM (WACV 2024)](https://openaccess.thecvf.com/content/WACV2024/papers/Cao_Spiking_Denoising_Diffusion_Probabilistic_Models_WACV_2024_paper.pdf)
- [SpikeGPT: Generative Pre-trained Language Model with SNNs (2023)](https://arxiv.org/abs/2302.13939)
- [SpikeBERT (arXiv, 2023)](https://arxiv.org/abs/2308.15122)
- [Spikformer: When SNN Meets Transformer (ICLR 2023)](https://arxiv.org/abs/2209.15425)
- [Meta-SpikeFormer / Spike-driven Transformer V2](https://openreview.net/forum?id=1SIBN5Xyw7)
- [Vacuum Spiker: SNN for Anomaly Detection (arXiv, 2025)](https://arxiv.org/abs/2510.06910)
- [Dynamic Spiking Graph Neural Networks (AAAI 2024)](https://arxiv.org/abs/2401.05373)
- [Autonomous Driving with SNNs (NeurIPS 2024)](https://proceedings.neurips.cc/paper_files/paper/2024/file/f7344147dbd1607deac3a7e5f33a23aa-Paper-Conference.pdf)
- [Population Coding in snnTorch](https://snntorch.readthedocs.io/en/latest/tutorials/tutorial_pop.html)
- [SpikingJelly (Science Advances, 2023)](https://www.science.org/doi/10.1126/sciadv.adi1480)
- [Spiking SNNs for Multimodal Audio-Visual Classification](https://dl.acm.org/doi/10.1145/3721981)
- [Exploring SNNs for Deep RL in Robotic Tasks (Scientific Reports, 2024)](https://www.nature.com/articles/s41598-024-77779-8)
- [ED-sKWS: Early-Decision Spiking NN for Keyword Spotting (2024)](https://arxiv.org/abs/2406.12726)
- [S3DNet: Spiking 3D Network for Point Cloud (2025)](https://www.sciencedirect.com/science/article/abs/pii/S0893608025010706)
- [When Audio Denoising Meets SNN (IEEE CAI, 2024)](https://ieeexplore.ieee.org/document/10605482/)
- [Continual Learning with Neuromorphic Computing: Survey (2024)](https://arxiv.org/abs/2410.09218)
