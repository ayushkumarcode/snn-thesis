...
The central quantitative finding of this thesis is the 16.70 percentage point gap between the \gls{snn} (47.15\% $\pm$ 4.50\%) and the matched \gls{ann} (63.85\% $\pm$ 3.07\%) under controlled conditions ($p = 0.001$, paired $t$-test; $p = 0.0625$, Wilcoxon signed-rank, the minimum achievable at $n = 5$). This gap is real, statistically significant, and non-trivial. It represents the empirical cost of spiking computation with surrogate gradient training on a small-data audio benchmark using a lightweight convolutional architecture.
